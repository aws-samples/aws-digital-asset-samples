...
| Secure private key custody and transaction signing, from single-key KMS accounts to MPC wallets in Nitro Enclaves | [AWS KMS Ethereum Accounts](https://github.com/aws-samples/aws-kms-ethereum-accounts), [AWS Nitro Enclave Blockchain Wallet](https://github.com/aws-samples/aws-nitro-enclave-blockchain-wallet) | Generate or import private keys in a hardened environment (KMS, Nitro Enclaves, or MPC co-signer), sign transactions without exposing key material, and restrict signing authority through key policies or enclave attestation. | [Fireblocks blog](https://aws.amazon.com/blogs/web3/build-a-real-world-asset-tokenization-solution-on-aws-with-fireblocks/) |
